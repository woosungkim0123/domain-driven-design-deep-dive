package com.woopay.money.application.service;


import com.woopay.common.UseCase;
import com.woopay.money.adapter.out.persistence.MemberMoneyJpaEntity;
import com.woopay.money.application.port.in.IncreaseMoneyRequestCommand;
import com.woopay.money.application.port.in.IncreaseMoneyRequestUseCase;
    ...
    public MoneyChangingRequest increaseMoneyRequest(IncreaseMoneyRequestCommand command) {
        ...
        if(memberMoneyJpaEntity != null) {
            return increaseMoneyPort.createMoneyChangingRequest(
                    ...
                    new MoneyChangingRequest.Uuid(UUID.randomUUID().toString())).toDomain();
        }
