...
public class MoneyChangingRequestJpaEntity {
    ...
    public MoneyChangingRequest toDomain() {
        return MoneyChangingRequest.generateMoneyChangingRequest(
                new MoneyChangingRequest.MoneyChangingRequestId(moneyChangingRequestId.toString()),
                new MoneyChangingRequest.TargetMembershipId(targetMembershipId),
                new MoneyChangingRequest.MoneyChangingType(moneyChangingType),
                new MoneyChangingRequest.ChangingMoneyAmount(moneyAmount),
                new MoneyChangingRequest.MoneyChangingStatus(changingMoneyStatus),
                uuid
        );
    }
}
